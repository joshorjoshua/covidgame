import 'package:corona_game/home.dart';
...
class internetShop extends StatefulWidget {
  @override
  _internetShopState createState() => _internetShopState();
}

class _internetShopState extends State<internetShop> {
  var categoryName = [
    "마스크 제작 속도",
    "마스크 기계 효율",
    "식료품",
    ...
    return Scaffold(
      ...
      body: Center(
        child: Stack(
          children: <Widget>[
            Image(
                image: AssetImage('assets/images/internetshop.png'),
                fit: BoxFit.fitWidth),
            //Positioned...
            //Positioned...
