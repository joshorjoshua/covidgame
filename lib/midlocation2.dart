...
import 'arcadeshop.dart';
import 'SharedPreferences.dart';

class midLocation2 extends StatefulWidget {
  @override
  _midLocation2State createState() => _midLocation2State();
}

class _midLocation2State extends State<midLocation2> {
  var categoryName = [
    "마스크 제작 속도",
    "마스크 기계 효율",
    "식료품",
    ...
    return Scaffold(
      ...
      body: Center(
        child: Stack(
          children: <Widget>[
            Image(
                image: AssetImage('assets/images/midlocation2.png'),
                fit: BoxFit.fitWidth),
            Positioned(
                right: 0,
                top: 10,
