...
class medsShop extends StatefulWidget {
  @override
  _medsShopState createState() => _medsShopState();
}

class _medsShopState extends State<medsShop> {
  var categoryName = [
    "마스크 제작 속도",
    "마스크 기계 효율",
    "위생용품",
    ...
    return Scaffold(
      ...
      body: Center(
        child: Stack(
          children: <Widget>[
            Image(
                image: AssetImage('assets/images/medshop.png'),
                fit: BoxFit.fitWidth),
            //Positioned...
            //Positioned...
