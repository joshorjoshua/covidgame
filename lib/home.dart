...
import 'midlocation.dart';
import 'midlocation2.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    addKeyNumToSF("maskNum", 0);
    addKeyNumToSF("perClick", 1);
    addKeyNumToSF("perSec", 1);
    addKeyNumToSF("survived", 0);
    addKeyNumToSF("item1", 3);
    addKeyNumToSF("item2", 0);
    addKeyNumToSF("item3", 0);
    addKeyNumToSF("item4", 0);
    addKeyNumToSF("item5", 0);
    addKeyNumToSF("item6", 0);
    addKeyNumToSF("item7", 0);
    addKeyNumToSF("item8", 0);
    addKeyNumToSF("item9", 0);
    addKeyNumToSF("item10", 0);
    addKeyNumToSF("item11", 0);
    addKeyNumToSF("item12", 0);
    addKeyNumToSF("item13", 0);
    addKeyNumToSF("item14", 0);
    addKeyNumToSF("item15", 0);
    addKeyNumToSF("item16", 0);
    addKeyNumToSF("item17", 0);
    addKeyNumToSF("item18", 0);
    addKeyNumToSF("item19", 0);
    addKeyNumToSF("item20", 0);
    addKeyNumToSF("item21", 0);
    addKeyNumToSF("item22", 0);
    addKeyNumToSF("item23", 0);
    addKeyNumToSF("item24", 0);
    addKeyNumToSF("item25", 0);
    addKeyNumToSF("item26", 0);
    addKeyNumToSF("item27", 0);
    addKeyNumToSF("item28", 0);
    addKeyNumToSF("item29", 0);
    addKeyNumToSF("item30", 0);
